...
This project is indexed by GitNexus as **web4** (60592 symbols, 134158 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
