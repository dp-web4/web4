...
This project is indexed by GitNexus as **web4** (60058 symbols, 132208 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
