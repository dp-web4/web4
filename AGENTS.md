...
This project is indexed by GitNexus as **web4** (28411 symbols, 74198 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
