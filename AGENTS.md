...
This project is indexed by GitNexus as **web4** (47062 symbols, 111452 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
