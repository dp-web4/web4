...
This project is indexed by GitNexus as **web4** (41822 symbols, 88142 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
