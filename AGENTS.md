...
This project is indexed by GitNexus as **web4** (43447 symbols, 92085 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
