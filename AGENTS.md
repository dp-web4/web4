...
This project is indexed by GitNexus as **web4** (42469 symbols, 89730 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
