...
This project is indexed by GitNexus as **web4** (59016 symbols, 132588 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
