...
This project is indexed by GitNexus as **web4** (42192 symbols, 88833 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
