...
This project is indexed by GitNexus as **web4** (41663 symbols, 87575 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
