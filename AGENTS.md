...
This project is indexed by GitNexus as **web4** (41888 symbols, 88077 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
