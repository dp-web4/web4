...
This project is indexed by GitNexus as **web4** (42007 symbols, 88552 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
