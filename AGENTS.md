...
This project is indexed by GitNexus as **web4** (41652 symbols, 87479 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
