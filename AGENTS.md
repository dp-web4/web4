...
This project is indexed by GitNexus as **web4** (29856 symbols, 77773 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
