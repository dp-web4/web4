...
| B4: Schema-validated JSON-LD round-trip tests | DONE | 48 tests, all 10 types validated against schemas |
...
B4 PR pending (worker/web4-20260324-060045).

---

## Pending Items

- Sprint 6 B5: SDK v0.10.1 version bump (B2-B4+B6 all complete)
