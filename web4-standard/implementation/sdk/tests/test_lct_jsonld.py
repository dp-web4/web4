...
class TestLCTContextFileConsistency:
    ...
    def test_full_lct_roundtrip_keys_in_context(self):
        ...
        # Fields whose values are user-defined dicts (not schema terms)
