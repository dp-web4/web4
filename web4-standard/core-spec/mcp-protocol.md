...
- The `reputation.trust_dimension_updates` deltas MUST conform to the reputation rules defined by the responding society's Law Oracle for the role context (per `reputation-computation.md` §4)
